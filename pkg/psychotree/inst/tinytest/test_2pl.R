...
fit_2PL <- pltree(spisa[,1:9] ~ age + gender, data = SPISA, itemtype = "2PL", maxit = 5000)
...
## load data and fit model ##
data("SPISA", package = "psychotree")
fit_2PL_mg <- pltree(spisa[,1:9] ~ gender | age + gender, data = SPISA, itemtype = "2PL", maxit = 5000)
