...
fit_2PL <- pltree(spisa ~ age + gender, data = SPISA, itemtype = "2PL", maxit = 5000)
...
# saveRDS(test_2PL, "inst/tinytest/test_2PL.RDS")
...
## load data and fit model ##
data("SPISA", package = "psychotree")
fit_2PL_mg <- pltree(spisa ~ gender | age + gender, data = SPISA, itemtype = "2PL", maxit = 5000)
...
# saveRDS(test_2PL_mg, "inst/tinytest/test_2PL_mg.RDS")
